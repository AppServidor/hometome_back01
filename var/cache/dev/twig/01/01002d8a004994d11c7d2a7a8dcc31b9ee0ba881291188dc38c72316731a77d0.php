...
class __TwigTemplate_7bb8501ceaff0df3a85e7118fc2b928352e795661278b40ee98e4f8781b8f997 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm('¿Quieres borrar el registro?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ user.id) }}\">
    <button class=\"btn\">Borrar</button>
</form>
", "user/_delete_form.html.twig", "/home/antonio/proyectoFinal/hometome/templates/user/_delete_form.html.twig");
    }
}
