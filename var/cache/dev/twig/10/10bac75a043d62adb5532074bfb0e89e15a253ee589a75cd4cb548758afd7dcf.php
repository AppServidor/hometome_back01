...
class __TwigTemplate_0d6443b4ee0b25b3bde2fbea2916f3a3ef6203b54b1c0b2023ef16438fcdfbb2 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 2
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 2, $this->source); })()), 'widget');
        echo "
    <button class=\"btn\">";
        // line 3
...
";
        // line 4
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 4, $this->source); })()), 'form_end');
        echo "
";
...
", "user/_form.html.twig", "/home/antonio/proyectoFinal/hometome/templates/user/_form.html.twig");
    }
}
